...
public final class PinnedQuery: GraphQLQuery {
  ...
  public let operationName: String = "Pinned"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, pinnedItems: PinnedItem) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "pinnedItems": pinnedItems.resultMap])
      }
      ...
      public struct PinnedItem: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeRepository(description: String? = nil, id: GraphQLID, languages: AsRepository.Language? = nil, name: String, owner: AsRepository.Owner, stargazerCount: Int) -> Node {
            return Node(unsafeResultMap: ["__typename": "Repository", "description": description, "id": id, "languages": languages.flatMap { (value: AsRepository.Language) -> ResultMap in value.resultMap }, "name": name, "owner": owner.resultMap, "stargazerCount": stargazerCount])
          }
          ...
          public struct AsRepository: GraphQLSelectionSet {
            ...
            public init(description: String? = nil, id: GraphQLID, languages: Language? = nil, name: String, owner: Owner, stargazerCount: Int) {
              self.init(unsafeResultMap: ["__typename": "Repository", "description": description, "id": id, "languages": languages.flatMap { (value: Language) -> ResultMap in value.resultMap }, "name": name, "owner": owner.resultMap, "stargazerCount": stargazerCount])
            }
...
public final class StarredQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "Starred"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, starredRepositories: StarredRepository) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "starredRepositories": starredRepositories.resultMap])
      }
...
public final class TopQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "Top"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, topRepositories: TopRepository) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "topRepositories": topRepositories.resultMap])
      }
...
public final class UserProfileQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(avatarUrl: String, email: String, followers: Follower, following: Following, id: GraphQLID, login: String, name: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "User", "avatarUrl": avatarUrl, "email": email, "followers": followers.resultMap, "following": following.resultMap, "id": id, "login": login, "name": name])
      }
...
public final class UserProfileReposQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "UserProfileRepos"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(avatarUrl: String, email: String, followers: Follower, following: Following, id: GraphQLID, login: String, name: String? = nil, pinnedItems: PinnedItem, topRepositories: TopRepository, starredRepositories: StarredRepository) {
        self.init(unsafeResultMap: ["__typename": "User", "avatarUrl": avatarUrl, "email": email, "followers": followers.resultMap, "following": following.resultMap, "id": id, "login": login, "name": name, "pinnedItems": pinnedItems.resultMap, "topRepositories": topRepositories.resultMap, "starredRepositories": starredRepositories.resultMap])
      }
